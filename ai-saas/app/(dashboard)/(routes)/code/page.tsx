...
const CodePage = () => {
    ...
    const onSubmit = async( values: z.infer<typeof formSchema>) => {
        try {
            ...
            const reponse = await axios.post("/api/code", { messages: newMessages });
    ...
    return (
        <div>
            ...
            <div className="px-4 lg:px-8">
                <div>
                    <Form {...form}>
                        <form className="rounded-lg border w-full p-4 px-3 md:-x-6 focus-within:shadow-sm grid grid-cols-12 gap-2" 
